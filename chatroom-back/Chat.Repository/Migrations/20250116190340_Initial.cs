        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_chat_messages_content_MinLength", "LENGTH(content) >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_chat_room_user", x => new { x.chat_room_id, x.participants_id });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_chat_room_user_users_participants_id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("19c912fb-d961-4e6c-a9a4-80696e35ff12"), null, "CompanyAdmin", "COMPANYADMIN" },
                    { new Guid("5d0659c3-811e-447e-9935-5404ab23e120"), null, "SuperAdmin", "SUPERADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_chat_room_user_participants_id",
